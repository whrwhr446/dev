...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath }/resources/style/images/title_arrow.gif"/> 部门管理
        </div>
...
<div id="MainArea">
    <table cellspacing="0" cellpadding="0" class="TableStyle">
        ...
        <c:forEach var="c" items="${departments }">
			<tr class="TableDetail1 template">
				<td><a href="list?id=${c.id }">${c.name}</a>&nbsp;</td>
				<td>${c.parent.name}&nbsp;</td>
				<td>${c.prescription}&nbsp;</td>
				<td><a href="delete?id=${c.id}" onClick="return window.confirm('这将删除所有的下级部门，您确定要删除吗？')" >删除</a>
					<a href="editUI?id=${c.id}">修改</a>
				</td>
			</tr>
        </c:forEach>
        </tbody>
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
            ...
            <a href="list?parentid=${parent.parent.id}"><img src="${pageContext.request.contextPath }/resources/style/blue/images/button/ReturnToPrevLevel.png" /></a>
        </div>
    </div>
</div>
